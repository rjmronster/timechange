...
def chr2cal(ddmonyyyy, hhmmsecff, verbose=False):
    """
...
#  this allows for no input so we can use input from a pipe
   ...
   if ( args.example ):
      print(usage)
      print("example:", "chr2cal.py 1-NOv-2025 11:01:10.123")
      quit()
#  allow for pipe input here
   ...
   if ( args.verbose ):
      ...
      print("output:")
   year, month, day, hour, minute, secondfrac = chr2cal(ddmonyyyy, hhmmsecff )
