#!/usr/bin/env python3
"""
Usage: This function will return GPS time given UTC time.
       Input is UTC. Output is GPS.
"""
usage = __doc__
...
def utc2gps(utc, verbose=False):
   return (taiutc(utc) + utc - 19.0)
...
#  this allows for no input so we can use input from a pipe 
   ...
   if ( args.example ):
      print(usage)
      print("example:", "utc2gps.py 815302800")
      quit()
